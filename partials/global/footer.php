  ...
  <div class="l-container--wide">
    <div class="u-flex u-flex-wrap u-gap-y-60 u-gap-x-40 md:u-justify-start lg:u-justify-between">
      <div class="u-flex u-flex-col u-gap-y-20 sm:u-gap-y-30 ">
         <h4 class=" u-italic u-text-25 u-font-normal">Un progetto di ricerca a cura di</h4>
      ...
      <div class="u-flex u-flex-col u-gap-y-20 sm:u-gap-y-30">
        <h4 class=" u-italic u-text-25 u-font-normal">Con il contributo di</h4>
         <div class="u-flex u-items-center" >
          <img src="<?php echo $brands['cariplo'] ?>" alt="Fondazione Cariplo logo">
         </div>
      </div>
      <div class="u-flex u-flex-col u-gap-y-20 sm:u-gap-y-30">
        <h4 class=" u-italic u-text-25 u-font-normal">Con la collaborazione di</h4>
