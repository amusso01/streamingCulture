...
<div x-data="{ modalShown: $persist(false).using(sessionStorage) , isModalOpen : null } " 
  ...
  <div  @click.outside="isModalOpen = false , modalShown = true" class="c-modal u-h-400 u-bg-white u-w-2/3 u-mx-auto u-flex u-flex-col u-items-center u-justify-center">
      <h3 class="u-mb-45 u-font-normal u-text-60 u-italic">Who's <span class=" u-font-bold u-not-italic" >your Dealer? </span></h3>
