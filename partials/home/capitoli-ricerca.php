...
<?php if($Capitoli) : ?>
  <?php foreach($Capitoli as $key => $capitolo) : ?>
    <section class="c-ricercaLink  u-border-t u-border-white <?php echo $capitolo['capitolo_attivo'] ? 'u-bg-text c-ricercaLink-'.$key : 'u-bg-purple-lighter u-pointer-events-none c-ricercaLink-disabled-'.$key ?>"  data-s2r="single" data-s2r-type="stagger-fade-in" >
